...
const { DEV_KEYSTORE, PUSHED_REQUEST_URN } = require('../consts');
...
<body>
  ...
  pushedRequestURN: PUSHED_REQUEST_URN,
  forceOIDCScope: false,
  forceURNRequestURI: false,
  requestURIParamRequired: false,
  nonceRequired: false,
  disableSessionEndpoints: false,
};
